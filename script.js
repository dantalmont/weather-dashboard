...
$("#city-search").on("click", function(event) {
  ...
  var queryURL = "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=" + city +"&appid=" + key;
  var temp = "Temp: "
  var humid = "Humidity: "
...
$.ajax({
  url: "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/uvi?appid=" +key + "&lat=" + json.coord.lat +"&lon=" + json.coord.lon,
  method: "GET"
  ...
  var fiveURL = "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/onecall?lat=" + json.coord.lat + "&lon=" + json.coord.lon + "&exclude=hourly,minutely&appid=" + key; 
  // console.log(fiveURL);
